...
def move_snake():
    ...
    head_x %= WIDTH     # modulo the x and y positions if they go out of bounds
    head_y %= HEIGHT
...
while True:
    oled.fill(0)
    if button_pressed(button_up) and direction != "DOWN":
        direction = "UP"
    if button_pressed(button_down) and direction != "UP":
        direction = "DOWN"
    if button_pressed(button_left) and direction != "RIGHT":
        direction = "LEFT"
    if button_pressed(button_right) and direction != "LEFT":
        direction = "RIGHT"
